...
public class LTDescr
{
	...
	public LTDescr setLayoutElementSize() 
	{
		this.type = TweenAction.LAYOUT_ELEMENT_SIZE;
		this.initInternal = () => { this.from = new Vector2(this.layoutElement.minWidth, this.layoutElement.minHeight); };
		this.easeInternal = () => { 
			Vector3 cachedTarget = easeMethod(); 
			this.layoutElement.minWidth = cachedTarget.x; 
			this.layoutElement.minHeight = cachedTarget.y; 
		};
		return this;
	}
	#endif
...
//		val = (val * val * val * val - 2f);
	...
	*/
	...
	public LTDescr setLayoutElement(UnityEngine.UI.LayoutElement lo) 
	{
		this.layoutElement = lo;
		return this;
	}
