			...
			*/
			...
			Pass
			{
				...
				half4 frag(v2f i) : COLOR
				{
					...
					#define GRABPIXEL(weight,kernelx) tex2Dproj( _HBlur, UNITY_PROJ_COORD(float4(i.uvgrab.x + _HBlur_TexelSize.x * kernelx * UNITY_ACCESS_INSTANCED_PROP(Props, _Size), i.uvgrab.y, i.uvgrab.z, i.uvgrab.w))) * weight
			...
			Pass
			{
				...
				half4 frag(v2f i) : COLOR
				{
					...
					#define GRABPIXEL(weight,kernely) tex2Dproj( _VBlur, UNITY_PROJ_COORD(float4(i.uvgrab.x, i.uvgrab.y + _VBlur_TexelSize.y * kernely * UNITY_ACCESS_INSTANCED_PROP(Props, _Size), i.uvgrab.z, i.uvgrab.w))) * weight
